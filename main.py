...
def test_one(server, id):
    arg = server.films_by_user(id)
    user_like = arg
    arg = arg[:15]
...
def test_app():
    ...
    for i in user_list:
        same_attributes, same_taste = test_one(server, i)
        a += same_attributes
        b += same_taste
        print(same_attributes, same_taste)
    print(a / len(user_list))
    print(b / len(user_list))
